...
// improved standard merge arrays
...
INLINE_DEF void MERGE_ARRAY_STD(SORT_TYPE *dest, SORT_TYPE *source, size_t sizeLeft, size_t size) {
  ...
  size_t j = sizeLeft;
  size_t out = 0;
  SORT_TYPE leftItem = source[i];
  SORT_TYPE rightItem = source[j];

  while (1) {
    if (SORT_CMP(leftItem, rightItem) > 0) {
      dest[out++] = rightItem;
      ++j;
      if (j >= size)
        break;
...
INLINE_DEF void MERGE_ITEM_4(SORT_TYPE *dest, SORT_TYPE left_0, SORT_TYPE *right) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_ITEMS_1_3(&dest[1], left_0, right[1], right[2], right[3]);
  } else {
    dest[0] = left_0;
    dest[1] = right_0;
    dest[2] = right[1];
...
INLINE_DEF void MERGE_3_2ITEMS(SORT_TYPE *dest, SORT_TYPE *left, SORT_TYPE right_0, SORT_TYPE right_1) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_ITEMS_3_1(&dest[1], left_0, left[1], left[2], right_1);
  } else {
    dest[0] = left_0;
    MERGE_ITEMS_2_2(&dest[1], left[1], left[2], right_0, right_1);
  }
}
...
INLINE_DEF void MERGE_4_2ITEMS(SORT_TYPE *dest, SORT_TYPE *left, SORT_TYPE right_0, SORT_TYPE right_1) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_4_ITEM(&dest[1], left, right_1);
  } else {
    dest[0] = left_0;
    MERGE_3_2ITEMS(&dest[1], &left[1], right_0, right_1);
  }
}
...
INLINE_DEF void MERGE_2ITEMS_3(SORT_TYPE *dest, SORT_TYPE left_0, SORT_TYPE left_1, SORT_TYPE *right) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_ITEMS_2_2(&dest[1], left_0, left_1, right[1], right[2]);
  } else {
    dest[0] = left_0;
    MERGE_ITEMS_1_3(&dest[1], left_1, right_0, right[1], right[2]);
  }
}
...
INLINE_DEF void MERGE_2ITEMS_4(SORT_TYPE *dest, SORT_TYPE left_0, SORT_TYPE left_1, SORT_TYPE *right) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_2ITEMS_3(&dest[1], left_0, left_1, &right[1]);
  } else {
    dest[0] = left_0;
    MERGE_ITEM_4(&dest[1], left_1, right);
  }
}
...
INLINE_DEF void MERGE_NA_3_3(SORT_TYPE *dest, SORT_TYPE *left, SORT_TYPE *right) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_3_2ITEMS(&dest[1], left, right[1], right[2]);
  } else {
    dest[0] = left_0;
    MERGE_2ITEMS_3(&dest[1], left[1], left[2], right);
  }
}
...
INLINE_DEF void MERGE_NA_4_3(SORT_TYPE *dest, SORT_TYPE *left, SORT_TYPE *right) {
  ...
  if (SORT_CMP(left_0, right_0) > 0) {
    dest[0] = right_0;
    MERGE_4_2ITEMS(&dest[1], left, right[1], right[2]);
  } else {
    dest[0] = left_0;
    MERGE_NA_3_3(&dest[1], &left[1], right);
  }
}
...
INLINE_DEF void MERGE_3_3(SORT_TYPE *dest, SORT_TYPE *source) {
  ...
  if (SORT_CMP(item_0, item_3) > 0) {
    dest[0] = item_3;
    MERGE_3_2ITEMS(&dest[1], source, source[4], source[5]);
  } else {
    dest[0] = item_0;
    MERGE_2ITEMS_3(&dest[1], source[1], source[2], &source[3]);
  }
}
...
INLINE_DEF void MERGE_3_4(SORT_TYPE *dest, SORT_TYPE *source) {
  ...
  if (SORT_CMP(item_0, item_3) > 0) {
    dest[0] = item_3;
    MERGE_NA_3_3(&dest[1], source, &source[4]);
  } else {
    dest[0] = item_0;
    MERGE_2ITEMS_4(&dest[1], source[1], source[2], &source[3]);
  }
}
...
INLINE_DEF void MERGE_4_3(SORT_TYPE *dest, SORT_TYPE *source) {
  ...
  if (SORT_CMP(item_0, item_4) > 0) {
    dest[0] = item_4;
    MERGE_4_2ITEMS(&dest[1], source, source[5], source[6]);
  } else {
    dest[0] = item_0;
...
INLINE_DEF void MERGE_4_4(SORT_TYPE *dest, SORT_TYPE *source) {
  ...
  if (SORT_CMP(item_0, item_4) > 0) {
    dest[0] = item_4;
    MERGE_NA_4_3(&dest[1], source, &source[5]);
  } else {
    dest[0] = item_0;
    MERGE_3_4(&dest[1], &source[1]);
  }
}
...
INLINE_DEF void MICRO_MERGE_SORT_5(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  if (SORT_CMP(item_0, item_1) > 0) {
    MERGE_2ITEMS_3(data, item_1, item_0, &temp[2]);
  } else {
    MERGE_2ITEMS_3(data, item_0, item_1, &temp[2]);
  }
}
...
INLINE_DEF void SMALL_MERGE_SORT_9(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_2(&data[4]);
  NANO_SORT_3(&data[6]);
  MERGE_2ITEMS_3(&temp[4], data[4], data[5], &data[6]);

  MERGE_ARRAY_STD(data, temp, 4, 9);
}
...
INLINE_DEF void SMALL_MERGE_SORT_10(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_2(&data[5]);
  NANO_SORT_3(&data[7]);
  MERGE_2ITEMS_3(&temp[5], data[5], data[6], &data[7]);

  MERGE_ARRAY_STD(data, temp, 5, 10);
}
...
INLINE_DEF void SMALL_MERGE_SORT_11(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_3(&data[5]);
  NANO_SORT_3(&data[8]);
  MERGE_3_3(&temp[5], &data[5]);

  MERGE_ARRAY_STD(data, temp, 5, 11);
}
...
INLINE_DEF void SMALL_MERGE_SORT_12(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_3(&data[6]);
  NANO_SORT_3(&data[9]);
  MERGE_3_3(&temp[6], &data[6]);

  MERGE_ARRAY_STD(data, temp, 6, 12);
}
...
INLINE_DEF void SMALL_MERGE_SORT_13(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_3(&data[6]);
  NANO_SORT_4(&data[9]);
  MERGE_3_4(&temp[6], &data[6]);

  MERGE_ARRAY_STD(data, temp, 6, 13);
}
...
INLINE_DEF void SMALL_MERGE_SORT_14(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_3(&data[7]);
  NANO_SORT_4(&data[10]);
  MERGE_3_4(&temp[7], &data[7]);

  MERGE_ARRAY_STD(data, temp, 7, 14);
}
...
INLINE_DEF void SMALL_MERGE_SORT_15(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_4(&data[7]);
  NANO_SORT_4(&data[11]);
  MERGE_ARRAY_STD(&temp[7], &data[7], 4, 8);

  MERGE_ARRAY_STD(data, temp, 7, 15);
}
...
INLINE_DEF void SMALL_MERGE_SORT_16(SORT_TYPE *data, SORT_TYPE *temp) {
  ...
  NANO_SORT_4(&data[8]);
  NANO_SORT_4(&data[12]);
  MERGE_ARRAY_STD(&temp[8], &data[8], 4, 8);

  MERGE_ARRAY_STD(data, temp, 8, 16);
}
...
SORT_DEF void SMALL_MERGE_SORT_LESSLOOPS(SORT_TYPE *data, SORT_TYPE *temp, const size_t size) {
  switch (size) {
    ...
    case 8:
      MICRO_MERGE_SORT_8(data, temp);
      break;

    case 9:
      SMALL_MERGE_SORT_9(data, temp);
      break;

    case 10:
      SMALL_MERGE_SORT_10(data, temp);
      break;

    case 11:
      SMALL_MERGE_SORT_11(data, temp);
      break;

    case 12:
      SMALL_MERGE_SORT_12(data, temp);
      break;

    case 13:
      SMALL_MERGE_SORT_13(data, temp);
      break;

    case 14:
      SMALL_MERGE_SORT_14(data, temp);
      break;

    case 15:
      SMALL_MERGE_SORT_15(data, temp);
      break;

    case 16:
      SMALL_MERGE_SORT_16(data, temp);
      break;

    default: {
      BINARY_INSERTION_SORT_START(data, 1, size);
    }
  }
}
...
SORT_DEF void SMALL_MERGE_SORT(SORT_TYPE *data, SORT_TYPE *temp, const size_t size) {
  switch (size) {
    ...
    case 7:
      SMALL_MERGE_SORT_7(data, temp);
      break;

    case 8:
      SMALL_MERGE_SORT_8(data, temp);
      break;
...
#undef MERGE_4_ITEM
#undef MERGE_ITEM_4
#undef MERGE_3_2ITEMS
#undef MERGE_4_2ITEMS
#undef MERGE_2ITEMS_3
#undef MERGE_2ITEMS_4
#undef MERGE_NA_3_3
#undef MERGE_NA_4_3
#undef MERGE_3_3
#undef MERGE_3_4
...
#undef SMALL_MERGE_SORT_7
#undef SMALL_MERGE_SORT_8
#undef SMALL_MERGE_SORT_9
#undef SMALL_MERGE_SORT_10
#undef SMALL_MERGE_SORT_11
#undef SMALL_MERGE_SORT_12
#undef SMALL_MERGE_SORT_13
#undef SMALL_MERGE_SORT_14
#undef SMALL_MERGE_SORT_15
#undef SMALL_MERGE_SORT_16
